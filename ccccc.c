void ccccc() {
  ...
  TFile *file = new TFile("/home/root1/Desktop/diplom/data/result_new/0.0/dmp_ag10um_1.6_0.0_0.99_0.07915_0.2_0.9967117_0.05_x-1.0_z-1.0mm_ds0.01_3000evt.root", "READ");
  if (!file) {
  ...
  TFile *fOut = new TFile("out_dmp_ag10um_1.6_0.0_0.99_0.07915_0.2_0.9967117_0.05_x-1.0_z-1.0mm_ds0.01_3000evt.root", "RECREATE");
  if (!fOut) {
    file->Close();
    std::cout << "[FAIL]" << std::endl;
    return;
